...
\author[1,2]{Fabio Aurelio D'Asaro}[
  orcid=0000-0002-6254-2372,
  email=fabioaurelio.dasaro@univr.it]
\cormark[1]

\author[3]{Giuseppe Primiero}[
  email=giuseppe.primiero@unimi.it]

\address[1]{Department of Human Sciences,
  University of Verona, Italy}

\address[2]{Department of Information Studies,
  University College London, UK}

\address[3]{Department of Philosophy ``Piero Martinetti,''
...
The first draft of this paper was written by the authors.
During the subsequent preparation of this work, the authors
used Claude (Anthropic) in order to: improve grammar and
editorial polish; perform adversarial-style review of the paper
and cross-checking of benchmark numbers against authoritative
sources; and provide assistance with the Lean source code of
the accompanying implementation.  After using this tool, the
